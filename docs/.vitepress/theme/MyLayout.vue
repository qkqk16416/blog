                ...
                if (typeof window !== undefined) {
                    ...
                    if (content_div) {
                        ...
                        const gitment = new Gitalk({
                            ...
                            owner: "qkqk16416", // GitHub repository 所有者
                            repo: "blog", // GitHub repository
                            clientID: "207d41e5e0757e4a277b", // 自己的clientID
                            clientSecret: "521b7c9ed692cfda9cfa6cfba8e9e643a288b4b8", // 自己的clientSecret
                            admin: ["qkqk16416"], // GitHub repository 所有者
